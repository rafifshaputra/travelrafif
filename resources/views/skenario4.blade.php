...
<div class="mobile" id="mobile" >
    ...
    <div class="contain" style="background-color:white;">
        ...
        <div class="rows" >
            <div class="column">
                <img id="imgcol1"onclick="gambarGanti1();onYouTubeIframeAPIReady1('3CLBZaYMSfk');" src="/img/hr/hrlobi1.jpg" alt="Snow" style="width:100%;height:150px;">
            </div>
            <div class="column">
                <img id="imgcol2" onclick="gambarGanti2();onYouTubeIframeAPIReady2('SDOhQeSVe7M');" src="/img/hr/hrkolamrenang1r.jpg" alt="Mountains" style="width:100%;height:150px;opacity:0.6">
            </div>
            <div class="column">
                <img id="imgcol3" onclick="gambarGanti3();onYouTubeIframeAPIReady3('74X_wSupr0w');"src="/img/hr/hrkamar1r.jpg" alt="Mountains" style="width:100%;height:150px;opacity:0.6">
            </div>
            <div class="column">
                <img id="imgcol4" onclick="gambarGanti4();onYouTubeIframeAPIReady4('YtLcnrV5Xxo');"src="/img/hr/hrrestaurant1r.jpg" alt="Forest" style="width:100%;height:150px;opacity:0.6">
            </div>
            <div class="column">
                <img id="imgcol5" onclick="gambarGanti5();onYouTubeIframeAPIReady5('p11rS7mgDS8');"src="/img/hr/hrrestaurant2r.jpg" alt="Forest" style="width:100%;height:150px;opacity:0.6">
            </div>
            ...
            <div id="demo" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <img src="/img/hr/hrkamardet.jpg" onclick="seeDetail();" alt="Los Angeles" width="1100" height="500" class="hover-shadow cursor">
                  </div>
        ...
        <div class="contain" style="font-size:36px;background-color:white">
            <div style="background-color:white;border-radius:15px;height:600px;">
                <div id="demos" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img src="/gif/hr/kamar.gif" alt="Los Angeles" width="1100" height="680" class="hover-shadow cursor">
                      </div>
                      <div class="carousel-item">
                        <img src="/gif/hr/kamarmandi.gif"alt="Chicago" width="1100" height="680" class="hover-shadow cursor">
                      </div>
                      <div class="carousel-item">
                        <img src="/gif/hr/kamarmandi2.gif" alt="Chicago" width="1100" height="680" class="hover-shadow cursor">
                      </div>
