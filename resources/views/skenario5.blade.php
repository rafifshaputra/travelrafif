...
<head>
    ...
    <script src="js/skenario5js/360changeImage.js"></script>
    <script src="js/skenario5js/gantiGambarPreview.js"></script>
        ...
        <div class="contain" style="background-color:white;">
            ...
            <div class="head" style="padding-left:3%;">
                ...
                <b><span style="font-size:36px"> <img src="https://imgur.com/XW23AfN.png" alt="Mountains" style="width:35px">
                    Lokasi</b></span>
                <div style="padding-top:1%; font-size:32px;"> Jalan Bogor 128. Bogor Barat. 346 </div><br>
            </div>
            <hr>
            <br>
    ...
    <div class="mobile2" id="mobile2" >
                ...
                <div id="demo" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img src="img/h8/hrkamar1r.jpg" onclick="openModal()" alt="Los Angeles" width="1100" height="500" class="hover-shadow cursor">>
                      </div>
                      <div class="carousel-item">
                        <img src="img/h8/kamarmandi1r.jpg" onclick="openModal()"alt="Chicago" width="1100" height="500" class="hover-shadow cursor">>
                      </div>
            ...
            <div style="padding:2px;background-color:white;">
                <div class="rows" style="width:100%;padding-left:4%;"  >
                    ...
                    <div class="column4" style="font-size:34px;">
                        ...
                        <img src="https://imgur.com/K5sza9m.png" height="20px" width="20px"> With Breakfast <br>
        ...
        <div id="detailKamar" style="display:none;">
            <div class="contain" style="font-size:36px;background-color:white">
                ...
                <span class="navbar-brand" href="#" style="font-size:28px;padding-left:2%;"><span style="color:green;">Sudah</span>termasuk sarapan!</span><br>
                <hr style="border: 1px solid gray;">
...
<div id="myModal" class="modal">
    ...
    <div class="modal-content" style="margin-top:5%;">
        ...
        <div class="rows">
            ...
            <div class="column">
                <img id="kmrbiasa"class="demo cursor" src="img/h8/hrkamar1r.jpg" style="width:100%;height:200px;opacity:1;"   onclick="gantiGambar1()" >
            </div>
            <div class="column" >
                <img id="kmrmandi"class="demo cursor" src="img/h8/kamarmandi1r.jpg" style="width:100%;height:200px;"  onclick="gantiGambar()" >
            </div>
        </div>
    </div>
</div>
