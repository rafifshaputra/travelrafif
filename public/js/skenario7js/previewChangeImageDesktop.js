function gantiGambard(){
    ...
    document.getElementById("previewImaged4").style.display="none";


    document.getElementById('textnums').innerHTML="1 / 4";
...
function gantiGambard2(){
    ...
    document.getElementById('textnums').innerHTML="2 / 4";
    document.getElementById('caption').innerHTML= "Kamar Tidur";
}
...
function gantiGambard3(){
    ...
    document.getElementById('textnums').innerHTML="3 / 4";
    document.getElementById('caption').innerHTML= "Kamar Tidur";
}
...
function gantiGambard4(){
    ...
    document.getElementById("previewImaged2").style.display="none";
    document.getElementById("previewImaged3").style.display="none";
    document.getElementById("previewImaged4").style.display="block";

    document.getElementById('textnums').innerHTML="4 / 4";
