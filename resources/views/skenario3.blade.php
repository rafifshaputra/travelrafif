...
<div class="desktop" id="desktop">
    ...
    <div class="contain" style="padding-top:2%;background-color:white;">
        ...
        <div class="rows" >
            <div class="column">
                <img id ="imgcold1"onclick="gambarGantid1();"src="hrlobi1.jpg" alt="Snow" style="width:100%;height:120px;opacity:1">
            </div>
            <div class="column">
                <img id ="imgcold2" onclick="gambarGantid2();" src="hrkolamrenang1.jpg" alt="Forest" style="width:100%;height:120px;opacity:0.6">
            </div>
            <div class="column">
                <img id ="imgcold3" onclick="gambarGantid3();"  src="hrkamar1.png" alt="Mountains" style="width:100%;height:120px;opacity:0.6">
            </div>
            <div class="column">
                <img id ="imgcold4" onclick="gambarGantid4();" src="hrrestaurant1.jpg" alt="Mountains" style="width:100%;height:120px;opacity:0.6">
            </div>
            <div class="column" style=" position: relative;text-align: center;color: white;">

                <img id ="imgcol5" onclick="openModalzz();" src="hrrestaurant3r.jpg" alt="Mountains" style="width:100%;height:120px;">
    ...
    <div style="padding-left:100px;padding-right:100px;padding-top:10px;padding-bottom:10px;">
        ...
        <div id="gambarutamasd14" data-u="image" style="width:100%;height:450px; display:none;"> </div>
            ...
            <div class="rows" id ="lobid" style="padding-top:1%;">
                ...
                <div class="column">
                    <img id="lobid1" src="hrlobi1.jpg" style="border-style:solid;width:100%;height:100px;" onclick="previewHomed1();" >
                </div>
                <div class="column" >
                    <img id="lobid2"src="hrlobi2.jpg" style="opacity:0.4;width:100%;height:100px;"onclick="previewHomed2();"  >
                </div>
                <div class="column" >
                    <img id="lobid3"src="hrlobi3.jpg" style="opacity:0.4;width:100%;height:100px;"onclick="previewHomed3();"  >
                </div>
                <div class="column" >
                    <img id="lobid4"src="hrliftlobi.jpg" style="opacity:0.4;width:100%;height:100px;"onclick="previewHomed4();"  >
                </div>
            </div>
            ...
            <div class="rows" id ="kolamrenangd"style="padding-top:1%;display:none;">
                ...
                <div class="column">
                    <img id="kolamrenangd1" src="hrkolamrenang1r.jpg" style="border-style:solid;width:100%;height:100px;" onclick="previewHomed5();" >
                </div>
                <div class="column" >
                    <img id="kolamrenangd2"src="hrkolamrenang2.jpg" style="opacity:0.4;width:100%;height:100px;"onclick="previewHomed6();"  >
                </div>
                <div class="column" >
                    <img id="kolamrenangd3"src="hrkolamrenang3.jpg" style="opacity:0.4;width:100%;height:100px;"onclick="previewHomed7();"  >
                </div>
                <div class="column" >
                    <img id="kolamrenangd4"src="hrkolamrenang4.jpg" style="opacity:0.4;width:100%;height:100px;"onclick="previewHomed8();"  >
                </div>
            </div>
            ...
            <div class="rows" id ="restorand"style="padding-top:1%;display:none;">
                ...
                <div class="column">
                    <img id="restorand1" src="hrrestaurant1r.jpg" style="border-style:solid;width:100%;height:100px;" onclick="previewHomed9();" >
                </div>
                <div class="column" >
                    <img id="restorand2"src="hrrestaurant2r.jpg" style="opacity:0.4;width:100%;height:100px;"onclick="previewHomed10();"  >
                </div>
                <div class="column" >
                    <img id="restorand3"src="hrrestaurant3.jpg" style="opacity:0.4;width:100%;height:100px;"onclick="previewHomed11();"  >
                </div>
            </div>
            ...
            <div class="rows" id="kamartidurd"style="padding-top:1%;display:none;">
                ...
                <div class="column" >
                    <img id="kamartidurd2"src="hrkamar3.jpg" style="opacity:0.4;width:100%;height:100px;"onclick="previewHomed13();"  >
                </div>
                <div class="column" >
                    <img id="kamartidurd3"src="hrkmrmndi3.jpg" style="opacity:0.4;width:100%;height:100px;"onclick="previewHomed14();"  >
                </div>
