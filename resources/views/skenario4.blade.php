...
<head>
 ...
 <!-- #region Jssor Slider Begin -->
    ...
    <script src="/js/360js/modalDetailDesktop.js"></script>
  ...
  <div class="desktop" id="desktop">
    ...
    <div class="contain" style="padding-top:2%;background-color:white;">
        ...
        <div class="rows" >
            ...
            <div class="column">
                <img id ="imgcol2d" onclick="gambarGanti2d();" src="hrkolamrenang1r.jpg" alt="Forest" style="width:100%;height:120px;opacity:0.6">
            </div>
            <div class="column">
                <img id ="imgcol3d" onclick="gambarGanti3d();"  src="hrkamar1.png" alt="Mountains" style="width:100%;height:120px;opacity:0.6">
            </div>
            <div class="column">
                <img id ="imgcol4d" onclick="gambarGanti4d();" src="hrrestaurant1r.jpg" alt="Mountains" style="width:100%;height:120px;opacity:0.6">
            </div>
            <div class="column">
            ...
            <div class="rows" >
                ...
                <div class="column">
                    ...
                    <div class="rows" style="width:100%;padding-top:2%" >
                        ...
                        <div class="column">
                            <img src="hrkmrmndi2.png" alt="Mountains"onclick="openModalz()" style="width:100%;height:60px;">
                        </div>
                        <div class="column">
      ...
      <div class="row">
        <div class="col-sm-8" style="padding:30px;">
            ...
            <div class="rows" style="padding-top:1%;">
                ...
                <br>
                <div class="column">
                    <img id="kmrmodal" src="hrkamardet.jpg" style="border-style:solid;width:100%;height:120px;" onclick="gambarModal();" >
                </div>
                <div class="column" >
                    <img id="kmrmandimodal"src="hrkmrmndi2.png" style="opacity:0.4;width:100%;height:120px;"onclick="gambarModal2();"  >
                </div>
                <div class="column" >
